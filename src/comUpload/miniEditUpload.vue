<template>
  <div class="wraper">
    ...
    <!-- <el-button @click="submitUpload" :disabled="!fileList[0]" type="primary" v-loading="loading" size="mini">确认上传</el-button> -->
  </div>
</template>
...
.upload >>> .el-upload-list--picture-card .el-upload-list__item-actions{
  font-size: 14px;
  margin: 0;
  padding: 0;
}
